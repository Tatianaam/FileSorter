...
public class Constant {
     ...
     public static final String NO_FOLDER = "Provided folder doesn't exist, try again.";
     public static final String NO_FOLDER_EXC = "Didn't get a valid folder to work with.";
